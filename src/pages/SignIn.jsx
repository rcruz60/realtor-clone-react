      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            ...
            {showPassword ? (
              <AiFillEyeInvisible onClick={() => setShowPassword(!showPassword)} className="text-2xl cursor-pointer absolute right-3 top-3" />               
            ) : (
              <AiFillEye onClick={() => setShowPassword(!showPassword)} className="text-2xl cursor-pointer absolute right-3 top-3" />
            )
